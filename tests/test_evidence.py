...
class TestReceiveGitHubEvent:
    ...
    def test_trusted_issue_comment_accepted(self) -> None:
    ...
    def test_pull_request_review_accepted_any_actor(self) -> None:
        payload = {
            "action": "submitted",
