...
def trap(height: List[int]) -> int:
    ...
    Two pointers converge from both ends. We always process the side
    with the smaller max, because that side is the bottleneck for
    water level at that pointer.
